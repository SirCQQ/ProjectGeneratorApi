...
const {get_all_projects,get_user_project_by_id,save_project} =require("./route modules/functions/project_fnctions");
...
app.get("/api/projects/get_project/:project_name",(req,res)=>{
